...
export default function Home () {
  return (
    <div className='flex flex-col items-center justify-center w-full text-lg'>
      ...
      <Link href='https://github.com/ds-square/smart-vulnerabilities/blob/main/SoK__A_Unified_Data_Model_for_Smart_Contract_Vulnerability_Taxonomies.pdf' target='_blank' rel='noreferrer' className='p-2 m-1 border hover:bg-slate-100'>Technical report</Link>
    </div>
  )
}
